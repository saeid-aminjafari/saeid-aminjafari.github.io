...
**Aminjafari, S**., Nilfouroushan, F., Carlvik, F., Darvishi, M., Eriksson, L. E. B., **2026** (preprint). Evaluating the European Ground Motion Service against Local InSAR Analysis along Key Swedish Corridors. EGUsphere. [DOI](https://doi.org/10.5194/egusphere-2026-3758)

Carlvik, F., **Aminjafari, S**., Eriksson, L., Palmqvist, C., **2026**. Assessment of railway transition zone settlements using InSAR: a comparison between Sentinel-1, TerraSAR-X and track recording car data. Proc. 12th European Workshop on Structural Health Monitoring. [DOI](https://doi.org/10.58286/33751)
...
**Aminjafari, S**., **2023**. Monitoring Water Availability in Northern Inland Waters from Space. PhD thesis, Department of Physical Geography, Stockholm University. [URL](https://www.diva-portal.org/smash/record.jsf?aq2=%5B%5B%5D%5D&c=1&af=%5B%5D&searchType=SIMPLE&sortOrder2=title_sort_asc&query=Saeid+Aminjafari&language=en&pid=diva2%3A1792553&aq=%5B%5B%5D%5D&sf=all&aqe=%5B%5D&sortOrder=author_sort_asc&onlyFullText=false&noOfRows=50&dswid=8514)
